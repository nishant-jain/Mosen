...
public class ProximitySensor extends SensorObject {
	...
	public ProximitySensor(Context App)
	{
		this.app = App;
		Manager=(SensorManager)this.app.getSystemService(Context.SENSOR_SERVICE); 
		SystemSensor = Manager.getDefaultSensor(Sensor.TYPE_PROXIMITY);
		this.SensorType = SensorLayer.TYPE_PROXIMITY;
